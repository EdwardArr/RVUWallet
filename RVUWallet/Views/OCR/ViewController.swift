...
//	@IBOutlet weak
    ...
    func layOutViews(){
        ...
        let myPreviewView = PreviewView()
        self.previewView = myPreviewView
        
        let myCutoutView = UIView()
        self.cutoutView = myCutoutView
        
        let myNumberView = UILabel()
        self.numberView = myNumberView
        ...
        cutoutView.topAnchor.constraint(equalTo: view.topAnchor).isActive = true
        cutoutView.bottomAnchor.constraint(equalTo: view.bottomAnchor).isActive = true
        cutoutView.leadingAnchor.constraint(equalTo: view.leadingAnchor).isActive = true
        ...
        cutoutView.backgroundColor = .green
        
        view.backgroundColor = .red
        
        print(cutoutView.frame)
    }
